...
- DO NOT add extra comments that a human wouldn't add or is inconsistent with the rest of the file
- DO NOT add extra defensive checks or try/catch blocks that are abnormal for that area of the codebase (especially if called by trusted / validated codepaths)
- DO NOT add casts to any to get around type issues
